...
class MessagesSettingsActivity : SettingsPageActivity() {
    ...
    override fun fillItems(items: ArrayList<UItem>, adapter: UniversalAdapter) {
        ...
        items.add(
            UItem.asCheck(
                TOGGLE_ROUND_CAMERA_60FPS,
                LocaleController.getString(R.string.InuRoundCamera60Fps),
            ).setChecked(InuConfig.ROUND_CAMERA_60FPS.value)
        )
        items.add(
            UItem.asButton(
    ...
    override fun onClick(item: UItem, view: View, position: Int, x: Float, y: Float) {
        when (item.id) {
            ...
            TOGGLE_ROUND_CAMERA_60FPS -> {
                val new = InuConfig.ROUND_CAMERA_60FPS.toggle()
                (view as? TextCheckCell)?.isChecked = new
            }
    ...
    companion object {
        ...
        private val TOGGLE_ROUND_CAMERA_60FPS = InuUtils.generateId()
        ...
        val PAGE = SearchRegistry.Page(
            ...
            entries = listOf(
                ...
                SearchRegistry.Entry("round-camera-60fps", R.string.InuRoundCamera60Fps, TOGGLE_ROUND_CAMERA_60FPS),
